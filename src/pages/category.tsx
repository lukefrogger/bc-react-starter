...
import { Card, SideMenu, ProductCard, Props as ProductCardProps, Typography, Pagination } from 'unsafe-bc-react-components';
  ...
  return (
    <Container>
      ...
      <Main>
        ...
        <Content>
          <Meta>
            <Typography variant="body-small">42 items in “Subcategory”</Typography>
            {
