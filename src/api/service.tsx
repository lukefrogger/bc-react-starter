...
export const getProduct = async (data = {}) =>
  await request(`/v3/catalog/products`, data)
...
export const getBrandName = async (data = {}) =>
  await request(`/v3/catalog/brands`, data)
    .then((res): object => res.data[0] || {})
    .then((res): any => res)
    .catch((err) => console.error(err));

export const getStorefront = async () =>
  await request(`/v2/store`)
    .then((res): object => res)
    .catch((err) => console.error(err));

export const getProductImages = async (productID = {}, firstOnly = true) =>
  await request(`/v3/catalog/products/${productID}/images`)
    .then((res): object => (firstOnly && res.data ? res.data[0] : res.data))
    .then((res): any => res)
    .catch((err) => console.error(err));

export const getCategory = async (categoryId = {}) =>
  await request(`/v3/catalog/categories/${categoryId}`)
    .then((res): object => res.data || {})
    .then((res): any => res)
    .catch((err) => console.error(err));

export const getCustomFields = async (data: any = {}) =>
  await request(`/v3/catalog/products/${data.id}/custom-fields`)
    .then((res): object => res.data || {})
    .then((res): object => res)
    .catch((err) => console.error(err));

export const getProductModifiers = async (data: any = {}) =>
  await request(`/v3/catalog/products/${data.id}/modifiers`)
    .then((res): object => {
      return res.data || {};
    })
    .catch((err) => console.error(err));
...
export const getProductOptions = async (data: any = {}) =>
  await request(`/v3/catalog/products/${data.id}/options`)
    .then((res): object => {
      return res.data || {};
    })
    .catch((err) => console.error(err));
...
export const getProductReviews = async (data: any = {}) =>
  await request(`/v3/catalog/products/${data.id}/reviews`)
    .then((res): object => {
      return res.data || {};
    })
    .catch((err) => console.error(err));
...
export const getProfile = async (data: any) =>
  await request(`/v3/customers`, data)
    .then((res): object => {
...
export const getShippingAddress = async (data: any) =>
  await request(`/v3/customers/addresses`, data)
    .then((res): object => {
      return res.data || [];
    })
    .catch((err) => console.error(err));
...
export const getWishlists = async (data: any) =>
  await request(`/v3/wishlists`, data)
    .then((res): object => {
      return res.data || [];
    })
    .catch((err) => console.error(err));
...
export const getOrder = async (orderId: string) =>
  await request(`/v2/orders/${orderId}`)
    .then((res): object => res || [])
    .catch((err) => {
      console.error(err);
    });
...
export const getOrderProducts = async (orderId: string) =>
  await request(`/v2/orders/${orderId}/products`)
    .then((res): object => res || [])
    .catch((err) => {
      console.error(err);
    });
...
export const searchProducts = async (searchTerm: string) =>
  await request(`/v3/catalog/products`, {
    keyword: searchTerm,
